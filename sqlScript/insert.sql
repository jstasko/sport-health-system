...
----------------------------------------------Kraj----------------------------------------------
insert into m_kraj values ('Bratislavskı','SK',100);
insert into m_kraj values ('Trnavskı','SK',200);
insert into m_kraj values ('Trenèiansky','SK',300);
insert into m_kraj values ('Nitriansky','SK',400);
insert into m_kraj values ('ilinskı','SK',500);
insert into m_kraj values ('Banskobystrickı','SK',600);
insert into m_kraj values ('Prešovskı','SK',700);
insert into m_kraj values ('Košickı','SK',800);
----------------------------------------------Okres----------------------------------------------
insert into m_okres values ('Bratislava I',100,101);
insert into m_okres values ('Bratislava II',100,102);
insert into m_okres values ('Bratislava III',100,103);
insert into m_okres values ('Bratislava IV',100,104);
insert into m_okres values ('Bratislava V',100,105);
insert into m_okres values ('Malacky',100,106);
insert into m_okres values ('Pezinok',100,107);
insert into m_okres values ('Senec',100,108);
insert into m_okres values ('Dunajská Streda',200,201);
insert into m_okres values ('Galanta',200,202);
insert into m_okres values ('Hlohovec',200,203);
insert into m_okres values ('Piešany',200,204);
insert into m_okres values ('Senica',200,205);
insert into m_okres values ('Skalica',200,206);
insert into m_okres values ('Trnava',200,207);
insert into m_okres values ('Bánovce nad Bebravou',300,301);
insert into m_okres values ('Ilava',300,302);
insert into m_okres values ('Myjava',300,303);
insert into m_okres values ('Nové Mesto nad Váhom',300,304);
insert into m_okres values ('Partizánske',300,305);
insert into m_okres values ('Povaská Bystrica',300,306);
insert into m_okres values ('Prievidza',300,307);
insert into m_okres values ('Púchov',300,308);
insert into m_okres values ('Trenèín',300,309);
insert into m_okres values ('Komárno',400,401);
insert into m_okres values ('Levice',400,402);
insert into m_okres values ('Nitra',400,403);
insert into m_okres values ('Nové Zámky',400,404);
insert into m_okres values ('Ša¾a',400,405);
insert into m_okres values ('Topo¾èany',400,406);
insert into m_okres values ('Zlaté Moravce',400,407);
insert into m_okres values ('Bytèa',500,501);
insert into m_okres values ('Èadca',500,502);
insert into m_okres values ('Dolnı Kubín',500,503);
insert into m_okres values ('Kysucké Nové Mesto',500,504);
insert into m_okres values ('Liptovskı Mikuláš',500,505);
insert into m_okres values ('Martin',500,506);
insert into m_okres values ('Námestovo',500,507);
insert into m_okres values ('Ruomberok',500,508);
insert into m_okres values ('Turèianske Teplice',500,509);
insert into m_okres values ('Tvrdošín',500,510);
insert into m_okres values ('ilina',500,511);
insert into m_okres values ('Banská Bystrica',600,601);
insert into m_okres values ('Banská Štiavnica',600,602);
insert into m_okres values ('Brezno',600,603);
insert into m_okres values ('Detva',600,604);
insert into m_okres values ('Krupina',600,605);
insert into m_okres values ('Luèenec',600,606);
insert into m_okres values ('Poltár',600,607);
insert into m_okres values ('Revúca',600,608);
insert into m_okres values ('Rimavská Sobota',600,609);
insert into m_okres values ('Ve¾kı Krtíš',600,610);
insert into m_okres values ('Zvolen',600,611);
insert into m_okres values ('arnovica',600,612);
insert into m_okres values ('iar nad Hronom',600,613);
insert into m_okres values ('Bardejov',700,701);
insert into m_okres values ('Humenné',700,702);
insert into m_okres values ('Kemarok',700,703);
insert into m_okres values ('Levoèa',700,704);
insert into m_okres values ('Medzilaborce',700,705);
insert into m_okres values ('Poprad',700,706);
insert into m_okres values ('Prešov',700,707);
insert into m_okres values ('Sabinov',700,708);
insert into m_okres values ('Snina',700,709);
insert into m_okres values ('Stará ¼ubovòa',700,710);
insert into m_okres values ('Stropkov',700,711);
insert into m_okres values ('Svidník',700,712);
insert into m_okres values ('Vranov nad Top¾ou',700,713);
insert into m_okres values ('Gelnica',800,801);
insert into m_okres values ('Košice I',800,802);
insert into m_okres values ('Košice II',800,803);
insert into m_okres values ('Košice III',800,804);
insert into m_okres values ('Košice IV',800,805);
insert into m_okres values ('Košice - okolie',800,806);
insert into m_okres values ('Michalovce',800,807);
insert into m_okres values ('Roòava',800,808);
insert into m_okres values ('Sobrance',800,809);
insert into m_okres values ('Spišská Nová Ves',800,810);
insert into m_okres values ('Trebišov',800,811);
----------------------------------------------Obce----------------------------------------------
Insert into m_adresa values ('Ábelová',2,102,'529311');
Insert into m_adresa values ('Abovce',3,102,'529320');
Insert into m_adresa values ('Abrahám',4,102,'529338');
Insert into m_adresa values ('Abrahámovce',5,103,'529346');
Insert into m_adresa values ('Abrahámovce',6,103,'529354');
Insert into m_adresa values ('Pikovce',7,103,'529362');
Insert into m_adresa values ('Abramová',8,104,'529401');
Insert into m_adresa values ('Laclavá',9,104,'529371');
Insert into m_adresa values ('Polerieka',10,104,'529389');
Insert into m_adresa values ('Abranovce',11,104,'529397');
Insert into m_adresa values ('Adamovské Kochanovce',12,104,'529419');
Insert into m_adresa values ('Adidovce',13,104,'529427');
Insert into m_adresa values ('Alekšince',14,105,'529435');
Insert into m_adresa values ('Andovce',15,105,'529443');
Insert into m_adresa values ('Andrejová',16,105,'529460');
Insert into m_adresa values ('Ardanovce',17,105,'529494');
Insert into m_adresa values ('Ardovo',18,106,'507831');
Insert into m_adresa values ('Arnutovce',19,106,'507890');
Insert into m_adresa values ('Báb',20,106,'507954');
Insert into m_adresa values ('Babie',21,106,'507962');
Insert into m_adresa values ('Babín',22,106,'508012');
Insert into m_adresa values ('Babiná',23,106,'508021');
Insert into m_adresa values ('Babindol',24,106,'508039');
Insert into m_adresa values ('Babinec',25,106,'508055');
Insert into m_adresa values ('Bacúch',26,106,'508063');
Insert into m_adresa values ('Bacúrov',27,106,'504556');
Insert into m_adresa values ('Báè',28,106,'508080');
Insert into m_adresa values ('Baèka',29,106,'508161');
Insert into m_adresa values ('Baèkov',30,106,'504629');
Insert into m_adresa values ('Baèkovík',31,106,'504637');
Insert into m_adresa values ('Baïan',32,106,'508195');
Insert into m_adresa values ('Bádice',33,106,'504769');
Insert into m_adresa values ('Badín',34,106,'504858');
Insert into m_adresa values ('Báhoò',35,106,'504874');
Insert into m_adresa values ('Bajany',36,106,'508233');
Insert into m_adresa values ('Bajè',37,106,'508241');
Insert into m_adresa values ('Bajerov',38,106,'504947');
Insert into m_adresa values ('Bajerovce',39,106,'508349');
Insert into m_adresa values ('Bajka',40,106,'500267');
Insert into m_adresa values ('Bajtava',41,106,'508365');
Insert into m_adresa values ('Baka',42,106,'504980');
Insert into m_adresa values ('Baláe',43,106,'508381');
Insert into m_adresa values ('Baldovce',44,107,'507806');
Insert into m_adresa values ('Balog nad Ip¾om',45,107,'507849');
Insert into m_adresa values ('Baloò',46,107,'507857');
Insert into m_adresa values ('Baòa',47,107,'507873');
Insert into m_adresa values ('Baòa Lucia',48,107,'507881');
Insert into m_adresa values ('Banka',49,107,'507946');
Insert into m_adresa values ('Bánov',50,107,'508047');
Insert into m_adresa values ('Bánovce nad Bebravou',51,107,'508101');
Insert into m_adresa values ('Biskupice',52,107,'508179');
Insert into m_adresa values ('Horné Ozorovce',53,107,'508187');
Insert into m_adresa values ('Bánovce nad Ondavou',54,107,'508225');
Insert into m_adresa values ('Banská Belá',55,107,'507989');
Insert into m_adresa values ('Banská Bystrica',56,107,'508250');
Insert into m_adresa values ('Banská Štiavnica',57,107,'508268');
Insert into m_adresa values ('Banské',58,107,'508306');
Insert into m_adresa values ('Banskı Studenec',59,107,'508314');
Insert into m_adresa values ('Bara',60,107,'508322');
Insert into m_adresa values ('Malá Bara',61,108,'507814');
Insert into m_adresa values ('Ve¾ká Bara',62,108,'507822');
Insert into m_adresa values ('Barca',63,108,'503681');
Insert into m_adresa values ('Bardejov',64,108,'507865');
Insert into m_adresa values ('Bardejovská Nová Ves',65,108,'545333');
Insert into m_adresa values ('Dlhá Lúka',66,108,'507903');
Insert into m_adresa values ('Bardejovská Zábava',67,108,'503797');
Insert into m_adresa values ('Bardejovské Kúpele',68,108,'503801');
Insert into m_adresa values ('Bardoòovo',69,108,'503819');
Insert into m_adresa values ('Bartošova Lehôtka',70,108,'507911');
Insert into m_adresa values ('Bartošovce',71,108,'555487');
Insert into m_adresa values ('Baška',72,108,'507938');
Insert into m_adresa values ('Baškovce',73,108,'507997');
Insert into m_adresa values ('Baškovce',74,108,'555495');
Insert into m_adresa values ('Bašovce',75,108,'503851');
Insert into m_adresa values ('Batizovce',76,108,'503894');
Insert into m_adresa values ('Bátka',77,108,'508071');
Insert into m_adresa values ('Bátorová',78,108,'508098');
Insert into m_adresa values ('Bátorove Kosihy',79,108,'508110');
Insert into m_adresa values ('Bátovce',80,108,'508136');
Insert into m_adresa values ('Jalakšová',81,108,'582549');
Insert into m_adresa values ('Beckov',82,108,'503983');
Insert into m_adresa values ('Beckovská Vieska',83,108,'508209');
Insert into m_adresa values ('Beharovce',84,108,'508217');
Insert into m_adresa values ('Becherov',85,108,'508276');
Insert into m_adresa values ('Belá',86,108,'508284');
Insert into m_adresa values ('Belá',87,108,'508292');
Insert into m_adresa values ('Kubíková',88,108,'508331');
Insert into m_adresa values ('Belá nad Cirochou',89,108,'555509');
--------------------------------------------Vyrobcovia liekov----------------------------------------------------------------
Insert into m_vyrobca_liekov values ('529311','AGEPHA PHARMA s.r.o. ',45703850);
Insert into m_vyrobca_liekov values ('529320','Alliance Healthcare s.r.o. organizaèná zloka ',36869562);
...
------------------------------------------------------Liek--------------------------------------------------------------------
insert into m_liek values (1,45703850,'Novalgin 500 mg','Silná akútna, chronická boles');
insert into m_liek values (2,36869562,'Anopyrin 100 mg','pri infarkte, po operáciách tepien, pri angíne');
insert into m_liek values (3,45687463,'Concor 5 tabl','pre srdciarov');
insert into m_liek values (4,50765973,'Stilnox 1 mg','nespavos');
insert into m_liek values (5,681725,'Milurit30 x 300 mg','metabolické poruchy (dna)');
insert into m_liek values (6,35917571,'Agen 30 x 5 mg','lieèba zvıšeného krvného tlaku a is-chémia myokardu');
insert into m_liek values (7,31561900,'Tritace 30 x 5mg','terapia hypertenzie');
insert into m_liek values (8,35748320,'Enelbin 100 x 100 mg','pri ochoreniach vyvolanıch poruchami prekrvenia konèatín a mozgu');
insert into m_liek values (9,36467308,'Coronal 30 x 5mg','pre srdciarov');
insert into m_liek values (10,31652859,'Pamycon 1 f¾aœka','na lieèbu rán, zápalov');

----------------------------------------------------Lekaren-------------------------------------------------------------------
insert into m_lekaren values ('529311','Lekáreò Dr.Max',1);
insert into m_lekaren values ('529320','Lekáreò Medical Park',2);
insert into m_lekaren values ('529338','Lekáreò ZDRAVIE',3);
insert into m_lekaren values ('529311','Lekáreò VERONIKA',4);
insert into m_lekaren values ('529338','Lekáreò PÚPAVA',6);
insert into m_lekaren values ('529311','Lekáreò Karpatia',7);
insert into m_lekaren values ('529320','Lekáreò na korze',8);

---------------------------------------------------Institut-------------------------------------------------------------------
insert into m_institut values (529311,'Nemocnica sv. Michala', 'Nemocnica pre pacientov s diabetom', 1);
